...
@EnableSwagger2
public class TeaTalksApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(TeaTalksApplication.class, args);
	}
	...
	public Docket swaggerSettings() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.tea.talks"))
